...
<body class="customCursor">
    ...
    <div class="page-wrapper">
        ...
        <header class="main-header-five">
            <nav class="main-menu main-header-five__inner">
                <div class="main-header-five__logo">
                   <a href="{{ route('index') }}"><img src="{{ asset('assets/images/resources/logo-4.png') }}" width="135" alt="oxpins"></a>
                </div>
        ...
        <!--Services Start-->
        <section class="service-one" style="background-image:url('{{ asset('assets/images/shapes/service-bg-1.jpg') }}')" id="service">
        ...
        <section class="testimonial-five" style="background-image:url('{{ asset('assets/images/shapes/testimonial-bg-5.png') }}')" id="testimonial">
            <div class="container">
