...
<?php    
	 $headTitle="Home Five || Oxpins || Oxpins HTML 5 Template ";
     $css = '<link rel="stylesheet" href="' . asset('assets/vendors/oxpins-icons-two/style.css') . '"/>
             <link rel="stylesheet" href="' . asset('https://fonts.googleapis.com/css2?family=Castoro:ital@0;1&display=swap') . '"/>
             <link rel="stylesheet" href="' . asset('assets/css/oxpins-update.css') . '"/>
             <link rel="stylesheet" href="' . asset('assets/css/oxpins-color-2.css') . '"/> 
             <link rel="stylesheet" href="' . asset('assets/css/oxpins-dark.css') . '"/> ';  
?>
...
<body class="custom-cursor home-five-dark">
    ...
    <div class="page-wrapper">
        ...
        <header class="main-header-five">
            <nav class="main-menu main-header-five__inner">
                <div class="main-header-five__logo">
                   <a href="{{ route('index') }}"><img src="{{ asset('assets/images/resources/logo-4-dark.png') }}" width="135" alt="oxpins"></a>
                </div>
            ...
            <div class="container">
                <div class="feature-five__inner" style="background-image:url('{{ asset('assets/images/shapes/feature-5-bg.png') }}')">
                    <div class="feature-five__item">
                        ...
                        <a class="feature-five__item__rm" href="contact') }}"></a>
                    </div><!-- fature-item -->
                    <div class="feature-five__item">
                        <div class="feature-five__item__icon">
                        ...
                        <a class="feature-five__item__rm" href="events') }}"></a>
                    </div><!-- fature-item -->
                    <div class="feature-five__item">
                        <div class="feature-five__item__icon">
                        ...
                        <a class="feature-five__item__rm" href="volunteer') }}"></a>
                    </div><!-- fature-item -->
                </div>
            </div>
        </section>
        ...
        <!--Services Start-->
        <section class="service-one" style="background-image:url('{{ asset('assets/images/shapes/service-bg-1-dark.jpg') }}')">
        ...
        <section class="testimonial-five" style="background-image:url('{{ asset('assets/images/shapes/testimonial-bg-5-dark.png') }}')">
            <div class="container">
                ...
                <div class="testimonial-five__carousel owl-carousel owl-theme thm-owl__carousel" data-owl-options='{
                    ...
                    <div class="item">
                        ...
                        <div class="testimonial-five__single">
                            <div class="testimonial-five__single__shape" style="background-image:url('{{ asset('assets/images/shapes/testimonial-5-shape-dark.png') }}')"></div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="news-four__single">
                            <div class="news-four__single__content">
                                ...
                                <a class="news-four__single__rm" href="newsDetails') }}">Read More</a>
                            </div>
            ...
            <div class="container">
                <div class="brand-four__carousel thm-owl__carousel owl-theme owl-carousel" data-owl-options='{
                    ...
                    <div class="brand-four__carousel__item">
                        <img src="{{ asset('assets/images/brand/brand-3-1-dark.png') }}" alt="oxpins">
                    </div><!-- /.owl-slide-item-->
                    <div class="brand-four__carousel__item">
                        <img src="{{ asset('assets/images/brand/brand-3-1-dark.png') }}" alt="oxpins">
                    </div><!-- /.owl-slide-item-->
                ...
                <div class="container">
                    <div class="site-footer-three__top">
                        <div class="site-footer-three__logo">
                           <a href="{{ route('index') }}"><img src="{{ asset('assets/images/resources/footer-logo-three.png') }}" alt="oxpins"></a>
                        </div>
