...
@php
    $headTitle='Home Two || Oxpins || Oxpins HTML 5 Template';
...
@section('content')
    ...
    <div class="page-wrapper">
                    ...
                    <div class="item">
                        ...
                        <div class="testimonial-two__single">
                            ...
                            <div class="testimonial-two__content">
                                <div class="testimonial-two__shape-1" style="background-image:url('{{ asset('assets/images/shapes/testimonial-two-shape-1-dark.png') }}')"></div>
        ...
        <section class="help">
            ...
            <div class="help-shape-1" style="background-image:url('{{ asset('assets/images/shapes/help-shape-1-dark.png') }}')"></div>
            <div class="container">
                <div class="row">
                    <!--Help Single Start-->
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
