...
@php
     ...
     $css = '<link rel="stylesheet" href="' . asset('assets/css/oxpins-rtl.css') . '"/>
             <link rel="stylesheet" href="' . asset('assets/css/oxpins-rtl-custom.css') . '"/> 
             <link rel="stylesheet" href="' . asset('assets/vendors/layerdrops-toolbar/css/layerdrops-toolbar.css') . '"/> '; 

     $script = '<script src="' . asset('assets/vendors/layerdrops-toolbar/js/js.cookie.min.js') . '"></script>
                    ...
                    <div class="main-menu__wrapper-inner">
                        <div class="main-menu__left">
                            ...
                            <div class="main-menu__shape-1 float-bob-x">
                                <img src="{{ asset('assets/images/shapes/main-menu-shape-1-rtl.png') }}" alt="">
                            </div>
                        </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer"
                            style="background-image:url('{{ asset('assets/images/backgrounds/main-slider-1-1-rtl.png') }}')">
                        </div>
                        <!-- /.image-layer -->
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer"
                            style="background-image:url('{{ asset('assets/images/backgrounds/main-slider-1-2-rtl.png') }}')">
                        </div>
                        <!-- /.image-layer -->
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer"
                            style="background-image:url('{{ asset('assets/images/backgrounds/main-slider-1-3-rtl.png') }}')">
                        </div>
                        <!-- /.image-layer -->
        ...
        <section class="about-one">
            <div class="about-one__shape-box-1">
                <div class="about-one__shape-1"
                    style="background-image:url('{{ asset('assets/images/shapes/about-one-shape-1.png') }}')">
                </div>
            </div>
            <div class="container">
                <div class="row">
