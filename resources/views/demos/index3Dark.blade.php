            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-12">
                        <div class="feature-three__single">
                            <div class="feature-three__img"
                                style="background-image:url('{{ asset('assets/images/resources/feature-3-1-dark.png') }}')"></div>
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="feature-three__single">
                            <div class="feature-three__img"
                                style="background-image:url('{{ asset('assets/images/resources/feature-3-2-dark.png') }}')"></div>
                            <div class="feature-three__title-box">
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="feature-three__single">
                            <div class="feature-three__img"
                                style="background-image:url('{{ asset('assets/images/resources/feature-3-3-dark.png') }}')"></div>
                            <div class="feature-three__title-box">
        ...
        <section class="causes-three">
            <div class="causes-three-bg-box">
                ...
                <div class="causes-three-shape-1"
                    style="background-image:url('{{ asset('assets/images/shapes/causes-three-shape-1-dark.png') }}')"></div>
            </div>
            <div class="container">
                    ...
                    <div class="item">
                        ...
                        <div class="testimonial-three__single">
                            ...
                            <div class="testimonial-three__shape-1"
                                style="background-image:url('{{ asset('assets/images/shapes/testimonial-three-shape-1-dark.png') }}')">
                            </div>
