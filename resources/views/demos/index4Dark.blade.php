...
<x-customCursor/>
    ...
    <div class="page-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="about-five__content">
                                ...
                                <div class="about-five__feature hover-item" style="background-image:url('{{ asset('assets/images/shapes/about-5-feature-bg-dark.png') }}')">
        ...
        <section class="testimonial-four" style="background-image:url('{{ asset('assets/images/shapes/testimonial-bg-4-dark.png') }}')">
            <div class="testimonial-four__shape" style="background-image:url('{{ asset('assets/images/shapes/testimonial-4-shape-dark.png') }}')"></div>
            <div class="container">
                <div class="section-title text-center">
        ...
        <!--Donate Start-->
        <section class="donate-one" style="background-image:url('{{ asset('assets/images/shapes/donate-shape-bg-dark.png') }}')">
