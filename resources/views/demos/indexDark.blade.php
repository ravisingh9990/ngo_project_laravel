...
@php
    ...
    $css = '<link rel="stylesheet" href="' . asset('assets/css/oxpins-dark.css') . '"/>'; 
@endphp
                                                                            ...
                                                                            <div class="demo-one__card">
                                                                                <div class="demo-one__image">
                                                                                    ...
                                                                                    <div class="demo-one__btns">
                                                                                        <a href="{{ route('index') }}" target="_blank" class="thm-btn">Multi Page </a>
                                                                                        <a href="{{ route('indexOnePage') }}" target="_blank" class="thm-btn">One Page</a>
                                                                                        <a href="{{ route('indexDark') }}" target="_blank" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                            ...
                                                                            <div class="demo-one__card">
                                                                                <div class="demo-one__image">
                                                                                    <img width="370" height="431" src="{{ asset('assets/images/home-showcase/home-1-2.png') }}"
                                                                                        alt="Home Page 02">
                                                                                    <div class="demo-one__btns">
                                                                                        <a href="{{ route('index2') }}" target="_blank" class="thm-btn">Multi Page </a>
                                                                                        <a href="{{ route('index2OnePage') }}" target="_blank" class="thm-btn">One
                                                                                            Page</a>
                                                                                        <a href="{{ route('index2Dark') }}" target="_blank" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                <div class="demo-one__content">
                                                                                    <h3 class="demo-one__title">
                                                                            ...
                                                                            <div class="demo-one__card">
                                                                                <div class="demo-one__image">
                                                                                    <img width="370" height="431" src="{{ asset('assets/images/home-showcase/home-1-3.png') }}"
                                                                                        alt="Home page 03">
                                                                                    <div class="demo-one__btns">
                                                                                        <a href="{{ route('index3') }}" target="_blank" class="thm-btn">Multi Page </a>
                                                                                        <a href="{{ route('index3OnePage') }}" target="_blank" class="thm-btn">One
                                                                                            Page</a>
                                                                                        <a href="{{ route('index3Dark') }}" target="_blank" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                <div class="demo-one__content">
                                                                                    <h3 class="demo-one__title">
                                                                            ...
                                                                            <div class="demo-one__card">
                                                                                <div class="demo-one__image">
                                                                                    <img width="370" height="431" src="{{ asset('assets/images/home-showcase/home-1-4.png') }}"
                                                                                        alt="Home page 04">
                                                                                    <div class="demo-one__btns">
                                                                                        <a href="{{ route('index4') }}" target="_blank" class="thm-btn">Multi Page </a>
                                                                                        <a href="{{ route('index4OnePage') }}" target="_blank" class="thm-btn">One
                                                                                            Page</a>
                                                                                        <a href="{{ route('index4Dark') }}" target="_blank" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                <div class="demo-one__content">
                                                                                    <h3 class="demo-one__title">
                                                                            ...
                                                                            <div class="demo-one__card">
                                                                                <div class="demo-one__image">
                                                                                    <img width="370" height="431" src="{{ asset('assets/images/home-showcase/home-1-5.png') }}"
                                                                                        alt="Home page 05">
                                                                                    <div class="demo-one__btns">
                                                                                        <a href="{{ route('index5') }}" target="_blank" class="thm-btn">Multi Page </a>
                                                                                        <a href="{{ route('index5OnePage') }}" target="_blank" class="thm-btn">One
                                                                                            Page</a>
                                                                                        <a href="{{ route('index5OnePage') }}" target="_blank" class="thm-btn">Dark Page</a>
                                                                                    </div><!-- /.demo-one__btns -->
                                                                                </div><!-- /.demo-one__image -->
                                                                                <div class="demo-one__content">
                                                                                    <h3 class="demo-one__title">
    ...
    <!-- /.stricky-header -->
                        ...
                        <div class="about-one__left">
                            <div class="about-one__img-box wow slideInLeft" data-wow-delay="100ms"
                                ...
                                <div class="about-one__shape-3 float-bob-y">
                                    <img src="{{ asset('assets/images/shapes/about-one-shape-3-dark.png') }}" alt="">
                                </div>
        ...
        <section class="become-volunteer-one">
            ...
            <div class="become-volunteer-one__shape-1"
                style="background-image:url('{{ asset('assets/images/shapes/become-volunteer-shape-1-dark.png') }}')"></div>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6  wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                        <div class="feature-one__single">
                            ...
                            <div class="feature-one__top">
                                <div class="feature-one__top-inner">
                                    ...
                                    <div class="feature-one__top-title-box">
                                        <h3 class="feature-one__top-title"><a href="{{ route('donationDetails') }}">Join us &
                                                become <br> a
                                                volunteer</a></h3>
                                    </div>
                                </div>
                            ...
                            <a href="{{ route('donationDetails') }}" class="thm-btn feature-one__btn">View details</a>
                        </div>
                    </div>
        ...
        <section class="brand-one">
            <div class="container">
                <div class="thm-swiper__slider swiper-container" data-swiper-options='{"spaceBetween": 100, "slidesPerView": 5, "autoplay": { "delay": 5000 }, "breakpoints": {
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="{{ asset('assets/images/brand/brand-1-1-dark.png') }}" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="{{ asset('assets/images/brand/brand-1-2-dark.png') }}" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="{{ asset('assets/images/brand/brand-1-3-dark.png') }}" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="{{ asset('assets/images/brand/brand-1-4-dark.png') }}" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="{{ asset('assets/images/brand/brand-1-5-dark.png') }}" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="{{ asset('assets/images/brand/brand-1-6-dark.png') }}" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="{{ asset('assets/images/brand/brand-1-1-dark.png') }}" alt="">
                        </div><!-- /.swiper-slide -->
