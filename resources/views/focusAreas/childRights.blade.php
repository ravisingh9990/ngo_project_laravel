...
@section('content')
                    ...
                    <section class="gallery-carousel-page">
                        <div class="container" style="padding-top: 50px;">
                            ...
                            <span class="section-title__tagline">Child Rights and Education</span>
                            <h2 class="section-title__title">Our Work Towards Child Rights and Education Area</h2>
                            </div>
                                ...
                                <div class="col-xl-12 col-lg-12">
                                    <div class="event-details__left">
                                        <div class="event-details__top" style="padding-top: 50px;">
                                            ...
                                            <h3 class="event-details__title">Our Work Towards Child Rights and Education Area</h3>
